...
export const Main = (props: IMainProps): JSX.Element => {
    ...
    const { title, ApprovalConfigData, primaryColor, guestRequestList, ...rest } = props;
    return (
        <main className="main_wrapper dash_wrapper" dir={getDirection()}>
            ...
            <div className="container">
                ...
                <DashMain {...rest} detailsFormUrl={props.newItemUrl} ApprovalConfigData={ApprovalConfigData} primaryColor={primaryColor} guestRequestList={guestRequestList}/>
            </div>
        </main>
    );
};
