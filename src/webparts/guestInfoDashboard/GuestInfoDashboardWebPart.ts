...
import GuestInfoDashboard from './components/GuestInfoDashboard';
import { IGuestInfoDashboardProps } from './components/IGuestInfoDashboardProps';
...
export interface IGuestInfoDashboardWebPartProps {
  description: string;
...
export default class GuestInfoDashboardWebPart extends BaseClientSideWebPart<IGuestInfoDashboardWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGuestInfoDashboardProps> = React.createElement(
      GuestInfoDashboard,
      {
        ...
        guestRequestList: this.properties.guestRequestList,
      }
    );
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyFieldListPicker("guestRequestList", {
                  label: "Select Guest Request From List",
                  selectedList: this.properties.guestRequestList,
                  includeHidden: false,
